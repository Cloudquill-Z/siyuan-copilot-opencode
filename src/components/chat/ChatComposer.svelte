<script lang="ts">
    ...
    export let activePermissionRequest: { permissionID: string; sessionID: string; tool: string; input: string; description: string } | null;
    ...
    export let commandPaletteIndex: number;
    export let contextDocuments: ContextDocument[];
    export let copyMessage: any;
    export let currentAttachments: MessageAttachment[];
    export let currentInput: string;
    export let currentModelId: string;
    export let currentActiveTaskId: string;
    export let composerStatusSummary: string;
    export let showThinkingToggle: boolean;
    export let currentThinkingSelectValue: ThinkingEffort | 'off';
    export let displayedContextPercent: number;
    export let displayedContextTokens: number;
    export let currentContextLimit: number | undefined;
    ...
    export let imageInputElement: HTMLInputElement;
    export let inputContainer: HTMLElement;
    export let isAddMenuOpen: boolean;
    export let isDragOver: boolean;
    export let isFetchingWebContent: boolean;
    export let isInputComposing: boolean;
    export let isLoading: boolean;
    export let isModelSelectorOpen: boolean;
    export let isPromptSelectorOpen: boolean;
    export let isSearchDialogOpen: boolean;
    export let isStatusMenuOpen: boolean;
    export let isUploadingFile: boolean;
    export let mode: 'sidebar' | 'dialog';
    ...
    export let questionDrafts: Array<{ selected: string[]; custom: string }>;
    ...
    export let showCommandPalette: boolean;
    ...
    export let unreadTaskIds: Set<string>;
