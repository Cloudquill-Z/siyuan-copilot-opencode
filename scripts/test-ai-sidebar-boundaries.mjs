...
assert.ok(metrics.totalLines <= 14_420, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 10_280, `unexpected script growth: ${metrics.scriptLines}`);
