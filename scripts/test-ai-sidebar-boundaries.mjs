...
assert.ok(metrics.totalLines <= 13_230, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 9_100, `unexpected script growth: ${metrics.scriptLines}`);
