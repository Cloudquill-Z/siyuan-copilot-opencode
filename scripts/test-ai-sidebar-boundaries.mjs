...
assert.ok(metrics.totalLines <= 11_500, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 7_360, `unexpected script growth: ${metrics.scriptLines}`);
