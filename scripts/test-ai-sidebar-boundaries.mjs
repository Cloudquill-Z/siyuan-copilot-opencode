...
assert.ok(metrics.totalLines <= 14_050, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 9_920, `unexpected script growth: ${metrics.scriptLines}`);
