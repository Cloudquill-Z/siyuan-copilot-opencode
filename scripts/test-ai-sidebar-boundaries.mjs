...
assert.ok(metrics.totalLines <= 13_990, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 9_850, `unexpected script growth: ${metrics.scriptLines}`);
