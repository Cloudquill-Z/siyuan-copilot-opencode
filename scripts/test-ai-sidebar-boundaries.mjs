...
assert.ok(metrics.totalLines <= 11_560, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 7_420, `unexpected script growth: ${metrics.scriptLines}`);
