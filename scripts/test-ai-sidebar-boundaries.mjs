...
assert.ok(metrics.totalLines <= 13_570, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 9_430, `unexpected script growth: ${metrics.scriptLines}`);
