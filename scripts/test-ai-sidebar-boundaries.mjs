...
assert.ok(metrics.totalLines <= 20_650, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 11_000, `unexpected script growth: ${metrics.scriptLines}`);
