...
assert.ok(metrics.totalLines <= 14_550, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 10_400, `unexpected script growth: ${metrics.scriptLines}`);
