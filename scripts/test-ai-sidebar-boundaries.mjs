...
assert.ok(metrics.totalLines <= 6_000, `unexpected sidebar growth: ${metrics.totalLines}`);
assert.ok(metrics.scriptLines <= 5_000, `unexpected script growth: ${metrics.scriptLines}`);
